...
from amazon.logger import logger
...
# def find_element_by_multiple_xpaths(driver, xpath_map):
#     """
#     Tries to find an element by iterating through a dict of {description: xpath}.
#     Logs and returns the first successful match.
#     """
#     for description, xpath in xpath_map.items():
#         try:
#             element = driver.find_element(By.XPATH, xpath)
#             logger.info(f"Found by {description}")
#             return element
#         except NoSuchElementException:
#             continue

#     logger.error("Search box not found using any known selectors")
#     return None

# def search_box(driver):
#     xpath_map = {
#         "placeholder": '//input[@placeholder="Search Amazon"]',
#         "ID": '//input[@id="nav-bb-search"]',
#         "title": '//input[@title="Search For"]'
#     }
#     return find_element_by_multiple_xpaths(driver, xpath_map)
# search_box = search_box(driver)
...
# sleeper(7,10)
# scroll_and_wait(driver)
# #is there any automation availabe in bs4
# # we can use base url and (reseach more on urls)